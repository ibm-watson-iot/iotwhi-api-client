...
class IoTWHIApiClient {
  ...
  createRecord(type, record, queryParams) {
    ...
    return this._getAdapter(type).createRecord(type, record, queryParams);
  }

  updateRecord(type, record, queryParams) {
    return this._getAdapter(type).updateRecord(type, record, queryParams);
  }

  deleteRecord(type, id, queryParams) {
    return this._getAdapter(type).deleteRecord(type, id, queryParams);
  }
